...
class ServerInstance {
	...
	public void onMessageReceived(MessageReceivedEvent event) {
		...
		if (commandString[0].equalsIgnoreCase("Newgame") || (commandString[0].equalsIgnoreCase("new"))) {
		...
		if (getGameState() == -2 && (msg.contains("!join") || msg.contains("!start") || msg.contains("!leave")
				|| msg.contains("new") || msg.contains("newgame"))) {
			textChannel.sendMessage("The game is offline and commands are disabled").queue();
		}
		if (getGameState() == -1 && (msg.contains("!join") || msg.contains("!start") || msg.contains("!leave")
				|| msg.contains("new") || msg.contains("newgame"))) {
